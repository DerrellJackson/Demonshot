...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate the prefab to be used for the ammo. If multiple prefabs are specified then a random prefab from the array will be selected. The prefab can be an ammo pattern - as long as it conforms to the Fireable interface")] 
    #endregion
    public GameObject[] ammoPrefabArray;

    #region Tooltip 
    [Tooltip("The material to be used for the ammo ( the color of it, use default line to make it basic ) ")]
    #endregion
    public Material ammoMaterial;

    #region Tooltip
    [Tooltip("If the ammo should 'charge' briefly before moving and after it is released then set the time of seconds for it to charge")]
    #endregion
    public float ammoChargeTime = 0.1f; 
    
    #region Tooltip
    [Tooltip("If the ammo has a charge time then specify what material it should render as while charching")]
    #endregion
    ...
    #region  Tooltip
    [Tooltip("The minimum speed of the ammo - goes in a random value between min and max speed")]   
    #endregion
    public float ammoSpeedMin = 20f;

    #region  Tooltip
    [Tooltip("The maximum speed of the ammo - goes in a random value between min and max speed")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("This is the minimum number of ammo that are spawned in per shot. A random number of ammo are spawned between the minimum and maximum values.")]
    #endregion
    public int ammoSpawnAmountMin = 1;

    #region Tooltip
    [Tooltip("This is the maximum number of ammo that are spawned in per shot. A random number of ammo are spawned between the minimum and maximum values.")]
    #endregion
    ...
    #region  Validation
#if UNITY_EDITOR
    //Validate the details entered in
