...
public class AmmoHitEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The color gradient for the ammo hit effect. This gradient show the color of particles during their lifetime - from left to right")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("The The start particle speed for the particle effect.")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("The gravity on the particles, a negative number will get the particles to float upwards instead of down.")]
    #endregion Tooltip
    public float effectGravity = -0.01f;

    #region Tooltip
    [Tooltip("The sprite used for the particle effect. If none is specified then it will just use the default one.")]
    #endregion Tooltip 
    public Sprite sprite;

    #region Tooltip
    [Tooltip("The min velocity for the particles over its lifetimes. A random value will be chosen between the min and max.")]
    #endregion Tooltip 
    public Vector3 velocityOverLifetimeMin;

    #region Tooltip
    [Tooltip("The max velocity for the particles over its lifetimes. A random value will be chosen between the min and max.")]
    #endregion Tooltip 
    public Vector3 velocityOverLifetimeMax;

    #region Tooltip
    [Tooltip("Contains the particle system for the hit effect. It is configured by the ammoHitEffectSO.")]
    #endregion Tooltip 
