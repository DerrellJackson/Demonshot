...
public class SoundEffectSO : ScriptableObject 
{
    ...
    #region Tooltip
    [Tooltip("The minimum pitch variation for the sound effect. A random pitch will be generated between the min and max values. A random pitch variation makes sound effects sound more natural.")]
    #endregion
    [Range(0.1f, 1.5f)]
    public float soundEffectPitchRandomVariationMin = 0.8f;

    #region Tooltip
    [Tooltip("The maximum pitch variation for the sound effect. A random pitch will be generated between the min and max values. A random pitch variation makes sound effects sound more natural.")]
    #endregion
    [Range(0.1f, 1.5f)]
