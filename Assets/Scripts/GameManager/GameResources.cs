...
public class GameResources : MonoBehaviour
{
    ...
    private static GameResources instance;//this will hold the prefab of this class
    ...
    #region Tooltip
    [Tooltip("The current player scriptable object - this is used to refrence the current player between scenes")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("Populate the music master mixer group")]
    #endregion 
    ...
    #region Tooltip 
    [Tooltip("The music low snapshot")]
    #endregion Tooltip 
    ...
    #region Tooltip
    [Tooltip("Populate with a health pickup sound effect")]
    #endregion 
    ...
    #region Tooltip
    [Tooltip("Populate with the melee weapon sound effect")]
    #endregion
    public SoundEffectSO meleePickup;
    ...
    #region Tooltip
    [Tooltip("Populate with the Bush Drop sound effect")]
    #endregion 
    public SoundEffectSO bushDrop;
    ...
    #region Tooltip
    [Tooltip("Populate the Variable Lit Shader")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("The area the enemy prefers to navigate to")]
    #endregion Tooltip 
    ...
    #endregion
    public GameObject ammoIconPrefab; //might turn this into an Array[] only because I may want it to switch depending on held weapon which will mean it will need to be held in WeaponStatusUI
    ...
    #region Validation
#if UNITY_EDITOR
    //validation of the scriptable object details being entered
