...
public class GridCursor : MonoBehaviour
{
    ...
    private void SetCursorValidity(Vector3Int cursorGridPosition, Vector3Int playerGridPosition)
    {
        ...
        {
            //determine cursor validity based on inventroy item selected and grid property details
            switch(itemDetails.itemType)
            {
                ...
                case ItemType.Drink:
                case ItemType.Furniture: //NEED TO ADD A CHECK FOR FURNITURE
                case ItemType.Decor: //NEED TO ADD A CHECK FOR DECOR
    ...
    //test cursor validity for a seed for the target grid property details, returns true if valid, but false otherwise
    ...
    //test cursor valitity for a commodity for the target grid property details, returns true if valid, but false otherwise
    ...
    //sets the cursor as either valid or invalid for the tool for the target grid property details. returns true if valid or false if invalid
    private bool IsCursorValidForTool(GridPropertyDetails gridPropertyDetails, ItemDetails itemDetails)
    {
        ...
        switch (itemDetails.itemType)
        {
            ...
            if(gridPropertyDetails.isDiggable == true && gridPropertyDetails.daysSinceDug == -1)
            {
                ...
                //loop through all items found to see if any are reapable type, player cannot dig in reapable scenery
            ...
            case ItemType.Collecting_tool: //this tool may not be used but I am writing it in for if I want a crop to require it
    ...
    public Vector3Int GetGridPositionForCursor() 
    {
        ...
        //z is how far the objects are in front of the camera
